...
def a(aValue): a = aValue
def b(bValue): self.b = bValue
def c(cValue): self.c = cValue
...
async def CozmoPlanning(robot: cozmo.robot.Robot, a, b, c):
...
async def detect_cube_and_update_cmap(robot, marked, cozmo_pos):
    ...
    for obj in robot.world.visible_objects:
        ...
        obstacle_nodes = []
        obstacle_nodes.append(get_global_node(0, (9, 13), Node((cube_padding, cube_padding))))
